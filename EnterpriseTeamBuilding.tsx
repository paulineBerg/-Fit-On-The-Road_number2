...
const items = [
  ...
  },
  {
    ...
    description:
      "Nos coachs sportifs diplômés vous accompagnent tout au long de votre événement, garantissant ainsi la sécurité et le bon déroulement de toutes les activités.",
    image: `url("${teamBuildingPic}")`,
  },
  {
...
function EnterpriseTeamBuilding() {
  ...
  return (
    <Container id="enterprise-team-building" sx={{ py: { xs: 8, sm: 16 } }}>
